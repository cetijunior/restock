    ...
    <div className="min-h-screen bg-gray-100 pb-32 px-4 pt-6 text-lg">
      ...
      {categories.map((category) => (
        <div key={category} className="mt-10">
          <h2 className="sticky top-60 bg-gray-100 z-30 py-2 text-xl font-bold text-green-700 border-b border-green-300">📂 {category}</h2>
              ...
              .map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-gray-600">💵 Shitje: {item.sell_price} L</p>
                    <p className="text-gray-800 font-semibold">📦 Blerje: {item.buy_price} L</p>
